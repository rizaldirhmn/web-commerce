...
const CreateBanner = props => {
    ...
    const onSubmit = e => {
        onSubmitBlog(formState.values, base64, history)
    }



    return loadingBlogData ? 
...
const mapDispatchToProps = dispatch => {
    return {
      onSubmitBlog: (formData, image, history) => dispatch(actions.addBlogList(formData, image, history)),
    }
}
