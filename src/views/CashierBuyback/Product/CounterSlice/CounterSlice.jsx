...
import { addToCartBuyback } from '../../../../actions/cartBuyback'
...
const CounterSlice = (props) => {
    const { handleModalClose, product, searchCustomerBuyback, addToCartBuyback } = props
    ...
    const onSubmit = () => {
        handleModalClose()
        addToCartBuyback(product.product.id, searchCustomerBuyback.status, count, history)
    }
...
export default connect(null, { addToCartBuyback })(CounterSlice)