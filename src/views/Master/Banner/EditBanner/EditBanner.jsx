...
const EditBanner = props => {
    ...
    const onSubmit = e => {
        onEditBanner(params.id, formState.values, base64, history)
    }

    useEffect(() => {
        onFetchCollection('', 1)
        onFetchDetailBanner(params.id, setFormState, setImage)
    }, [onFetchCollection, onFetchDetailBanner, params, setFormState, setImage])

    return loadingBannerData || loadingFetchCollection || collectionList === null || loadingBannerDetail ? 
...
const mapStateToProps = state => {
    return {
        ...
        bannerDetail: state.banner.bannerDetail,
        loadingBannerDetail: state.banner.loadingBannerDetail
    }
}

const mapDispatchToProps = dispatch => {
    return {
      onEditBanner: (id, formData, image, history) => dispatch(actions.editBanner(id, formData, image, history)),
      onFetchDetailBanner: (id, setFormState, setImage) => dispatch(actions.fetchDetailBanner(id, setFormState, setImage)),
