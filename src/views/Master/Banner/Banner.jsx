...
const Banner = props => {
  ...
  const onClickDeleteBanner = event => {
    onDeleteBanner(event.id)
  ...
  <Fragment>
    <div className={classes.root}>
        ...
        >
            ...
            <Grid item>  
                <Button className={classes.button} component={CustomRouterLink} to='/banner/create'>
                                      ...
                                      <Grid container spacing={2}>
                                        <Grid item>
                                          <Tooltip arrow title="Edit Banner">
                                            <IconButton component={CustomRouterLink} to={`/banner/edit/${row.id}`}>
        ...
        >
            ...
            <DialogActions>
                ...
                <Button className={classes.button} onClick={() => onClickDeleteBanner(openDialogConfirmation.item)}>
                    Yes
                </Button>
            </DialogActions>
        </Dialog>
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onDeleteBanner : (id) => dispatch(actions.deleteBanner(id))
