...
const CreateCategory = props => {
    ...
    const onSubmit = e => {
        onSubmitSocialMedia(formState.values, imageUrl.url, history)
    }
    ...
    return loadingAddSocialMedia || loadingUploadImage ? 
                        ...
                        >
                            ...
                            >
                                <TextField 
                                    ...
                                    defaultValue={formState.values.ref_url || ''}
                                    onChange={handleChange}
                                    helperText={
...
const mapDispatchToProps = dispatch => {
    return {
      onUploadImage: (storeData) => dispatch(actions.uploadSocialMediaImage(storeData)),
      onAlert: (message, status) => dispatch(actions.setAlert(message, status)),
      onSubmitSocialMedia: (formData, imageUrl, history) => dispatch(actions.addSocialMedia(formData, imageUrl, history)),
