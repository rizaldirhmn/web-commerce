...
const ProductNotif = props => {
    ...
    const {
        onSendNotificationInformation,
        loadingNotificationInformation
    } = props
    ...
    const onSendNotif = () => {
        onSendNotificationInformation(formState.values, idProduct.id_product, history)
    ...
    return loadingNotificationInformation ?
    ...
    <Fragment>
        ...
        >
            <DialogContent>
                <BannerList handleChangeProduct={handleChangeProduct} />
            </DialogContent>
        </Dialog>
    </Fragment>
}
...
const mapStateToProps = state => ({
    loadingNotificationInformation : state.notification.loadingNotificationInformation
})

const mapDispatchToProps = dispatch => {
    return {
        onSendNotificationInformation : (formData, idBanner, history) => dispatch(actions.sendNotificationInformation(formData, idBanner, history))
    }
}
