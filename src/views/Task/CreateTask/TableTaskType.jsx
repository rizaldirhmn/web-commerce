...
const columns = [
  ...
  { id: 'code', label: 'Node', minWidth: 100 },
                ...
                <TableBody>
                        {stableSort(taskType.data, getComparator(order, orderBy)).map(
                            (row, index) => {
                                ...
                                return (
                                    <TableRow key={row.id} hover onClick={e => handleSelectTaskTypeChange(row)}>
...
export default connect(mapStateToProps, { getTaskType })(TableTaskType)