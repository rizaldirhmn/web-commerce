...
const SchemaValidation = yup.object().shape({
    ...
    retype_password: yup.string().equalTo(yup.ref('password'), 'Kata Sandi harus sama'),
})
...
const CreateUser = props => {
    ...
    const onSubmit = e => {
        ...
        onSubmitUser(params.id, formState.values, history)
    }

    useEffect(() => {
        onFetchingUserRoleList()
        onFetchDetailUser(params.id, setFormState)
    }, [onFetchingUserRoleList, onFetchDetailUser, params, setFormState])

    return loadingAddSocialMedia || loadingUserRoleList || userRoleList === null || loadingDetailUser || detailUser === null ? 
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    >
                                        <TextField 
                                            ...
                                            value={formState.values.number_handphone || ''}
                                            onChange={handleChange}
                                            helperText={
...
const mapStateToProps = state => ({
    ...
    loadingDetailUser: state.user.loadingDetailUser,
...
const mapDispatchToProps = dispatch => {
    return {
      ...
      onSubmitUser: (id, formData, history) => dispatch(actions.editUser(id, formData, history)),
      onFetchingUserRoleList: () => dispatch(actions.fetchUserRoleList()),
      onFetchDetailUser: (id, setFormState) => dispatch(actions.fetchDetailUser(id, setFormState))
    }
}
