...
const InputOrder = ({ getProduct, addPurchaseOrderDetail, product: { products, loading} }) => {
...
export default connect(mapStateToProps, { getProduct, addPurchaseOrderDetail })(InputOrder)